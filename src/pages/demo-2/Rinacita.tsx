...
const GALLERY: MasonryItem[] = [
  ...
  {
    id: "g7",
    img: "https://images.unsplash.com/photo-1484723091739-30990ffd8a9e?w=800&q=80",
    url: "#",
    height: 700,
  },
  {
    ...
    >
      ...
      <img
        ...
        style={{
          ...
          animation: isSliding
            ? "rinSlideOut 1.1s cubic-bezier(0.76,0,0.24,1) forwards"
            : "none",
        }}
      />
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            Russo, nuestra fundadora, quería crear un lugar donde la comida
            fuera memoria y conversación al mismo tiempo.
          </p>
          <p
            className="story-el"
            style={{
      ...
      >
        ...
        >
          Reserva con antelación para garantizar tu lugar. Disponibles para
          grupos de 2 a 20 personas.
        </p>
        <div
          className="reveal"
          style={{
